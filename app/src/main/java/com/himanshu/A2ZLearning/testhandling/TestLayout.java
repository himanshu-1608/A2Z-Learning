package com.himanshu.a2zlearning.testhandling;
...
public class TestLayout extends AppCompatActivity {
    ...
    final static String Total = "total.txt";
    final static String Correct = "correct.txt";
    final static String TestName = "testname.txt";
    int queCount;
    ...
    public void StartActivities(View v, int quecount, long timeleft) {
    ...
    public void setQuestions(StringBuilder rawText) {
    ...
    public void updatePerformance(String filename) {
