...
public class JeeMains extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav_view.setNavigationItemSelectedListener(menuItem -> {
            ...
            if(id == R.id.profile) {
                ...
                startActivity(new Intent(JeeMains.this,AboutUs.class));
            } else if(id == R.id.helpsupport) {
                startActivity(new Intent(JeeMains.this,HelpandSupport.class));
            } else if(id == R.id.faq) {
                startActivity(new Intent(JeeMains.this,Faq.class));
            }
            return true;
        });
